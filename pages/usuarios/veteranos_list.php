...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-building-o"></i> Veteranos Encontrados</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
...
if (!$resp1) { // Error en la ejecución del query
    echo "<div class='alert alert-block alert-danger fade in'>
        ...
        //exit;  echo "&idtipo=".$idtipo."&institucion=".$_SESSION['usuario_institucion']."";
    ...
    echo "<div class='alert alert-block alert-warning fade in'>
                ...
                <p>
                    <center>
                        <div class='btn-group' >
                            <a class='btn btn-success' target='' href='index.php?p=usuarios/av_usuarios_edit.php'><i class='fa fa-plus-circle'></i> Ingresar un nuevo Veterano</a>
                            <a class='btn btn-primary' href='index.php?p=usuarios/veteranos_busc.php'><i class='fa fa-search'></i> Buscar nuevamente</a>
                        </div>
                    </center>
                </p>
          </div>";
