    ...
    if ($id == "0" or $id == "") {
        ...
        if (!$resp1) { // Error en la ejecución del query*
            ...
            while($row = mysql_fetch_assoc($resp1)) {
                ...
                $armas_servicios = utf8_encode($row['armas_servicios']);
            }
...
<div id="page-wrapper">
    <div class="container-fluid">
                        ...
                        <form class="form-horizontal" role="form" action="index.php" method="post" enctype="multipart/form-data">
                            <div class="tabbable header-tabs">
                                <ul class="nav nav-tabs">
                                    ...
                                    <!--
                                    <li><a href="#box_tab4" data-toggle="tab"><i class="fa fa-file"></i> <span class="hidden-inline-mobile">Archivos</span></a></li>
                                    -->
                                </ul>
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade in active" id="box_tab1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="beneficiario" class="col-sm-3 control-label">Tipo de Beneficiario</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="profesion" class="col-sm-3 control-label">Profesión u Oficio</label>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="vecindad" class="col-sm-2 control-label">Municipio</label>
                                            <div class="col-sm-3">
                                    ...
                                    <div class="tab-pane fade" id="box_tab3">
                                        ...
                                        <div class="form-group">
                                            <label for="sueldo_mensual" class="col-sm-2 control-label">Ultimo Sueldo</label>
                                            <div class="col-sm-4">
                                        ...
                                        <?php if ($_SESSION['usuario_nivel'] <= 2 OR $_SESSION['usuario_nivel'] == 4) { ?>
                                            <div class="col-sm-offset-2 col-sm-10">
                                                ...
                                                <small id="passwordHelpInline" class="text-muted">
                                                    Recuerde hacer click en el boton para guardar sus ultimos cambios y Foto.
                                                </small>
                                            </div>
                                        <?php } ?>
        ...
        <center><small class="text-muted">&nbsp;</small></center>
    </div> <!-- /.container-fluid * -->
</div> <!-- /#page-wrapper * -->
