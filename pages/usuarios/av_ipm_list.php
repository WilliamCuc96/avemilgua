...
//Definición de Variables locales *
    ...
    $sql1 = "SELECT a.id as vid,
                    ...
                    a.numero_catalogo,
                    a.direccion,
                    (select b.nombre from ap_municipios b where b.id = a.municipio) as municipio,
                    a.telefono
                    FROM av_datos_ipm a WHERE 1 = 1";
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header"><i class="fa fa-users"></i> Listado de Ingresadoss</h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- /.row -->
                        ...
                        <table class="table table-responsive table-striped table-bordered table-hover" id="dt-usuarios">
                            <thead>
                                <tr>
                                    ...
                                    <th class="hidden-xs hidden-sm">Número de Catálogo</th>
...
<?php
    while($row=mysql_fetch_assoc($resp1)){
        ...
        print "  <td class='hidden-xs hidden-sm'>".utf8_encode($row['numero_catalogo'])."</td>";
        ...
        print "  <td class='center' align='center' nowrap>
                    <a href='index.php?p=usuarios/av_ipm_edit.php&id=".$row['vid']."' title='Editar Usuario' ><button class='btn btn-xs btn-default'><i class='fa fa-pencil'></i></button></a>
                    <a href='index.php?p=usuarios/av_ipm_gestion.php&id=".$row['vid']."&btn=Borrar' title='Borrar Usuario' ><button class='btn btn-xs btn-default'><i class='fa fa-times'></i></button></a>
                 </td>";
        print "</tr>";
    }
?>
